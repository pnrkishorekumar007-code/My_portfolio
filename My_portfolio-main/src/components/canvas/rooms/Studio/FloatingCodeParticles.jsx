...
const SYMBOLS = [
    ...
    // Arrows & misc
    { text: 'â†‘', size: 0.4, weight: 2 },
    { text: 'â†’', size: 0.4, weight: 1 },
    { text: 'â†', size: 0.4, weight: 1 },
    { text: 'Ã—', size: 0.3, weight: 2 },
    { text: 'â€¢', size: 0.25, weight: 3 },
    { text: 'â—‹', size: 0.3, weight: 2 },

    // Pixel-like patterns
    { text: 'â–ªâ–ª\nâ–ª', size: 0.25, weight: 2 },
    { text: 'â–ª â–ª\n â–ª', size: 0.25, weight: 1 },
    { text: 'â–ªâ–ªâ–ª', size: 0.2, weight: 2 },
];
...
const FloatingCodeParticles = ({ towerRotationRef, fallOffsetRef }) => {
    ...
    useFrame((state, delta) => {
        ...
        particles.forEach((particle, index) => {
            ...
            // User said: "jak sie obraca wierza w lewo to te czÄ…steczki leca w lewo"
