...
// ============================================
// ⚙️ PAINT CONFIGURATION - TWEAK HERE (From-Where To-Where)
// Edit these values to change the direction and range of the entry animation
// ============================================
const STUDIO_PAINT_CONFIG = {
    dirX: 0.0,
    dirY: -1.0,    // Direction: from top (-1) to bottom
    dirZ: 0.0,
    startDist: -10.0, // Wave start
    endDist: 10.0,   // Wave end
    noiseAxes: 'xz'  // Noise plane
};

// ============================================
// ⚙️ AUDIO SETTINGS - TWEAK HERE
// Edit these values to change the volume and audibility range of monitor hum noise
// ============================================
...
const StudioRoom = ({ showRoom, onReady, isExiting, isWarmup }) => {
    ...
    }, [latestContent, responsiveParams.towerRadius, activeContent]);
...
const MonitorBlock = memo(({ item, meshRef, isSelected, onMonitorClick, disabled, paintOnBeforeCompile, paintUniforms }) => {
    ...
    const matRefs = useMemo(() => [matRef0, matRef1, matRef2, matRef3, matRef4, matRef5], [matRef0, matRef1, matRef2, matRef3, matRef4, matRef5]);
