  ...
  useEffect(() => {
    ...
    gsap.to(trackerRef.current, {
      ...
      onUpdate: () => {
        ...
        if (safeProgress < 25) statusMsg = "Sharpening the pencils...";
        else if (safeProgress < 50) statusMsg = "Compiling Django backend...";
        else if (safeProgress < 70) statusMsg = "Rendering React components...";
        else if (safeProgress < 85) statusMsg = "Wiring up the corridor...";
        else if (safeProgress < 95) statusMsg = "Polishing pixels...";
        else statusMsg = "Opening the sketchbook...";
