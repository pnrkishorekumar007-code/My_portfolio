...
const ScreenReaderOverlay = () => {
    ...
    // Fetch data to generate invisible HTML for SEO / crawlers
    ...
    return (
        <div className="sr-overlay" role="complementary" aria-label="Accessible navigation for 3D portfolio">
            ...
            <nav id="sr-main-nav" className="sr-only" aria-label="Portfolio rooms">
                <h1>Kishorekumar R — Full-Stack Developer</h1>
                <h2>Portfolio Navigation</h2>

                {!hasEntered && (
                    <p>Welcome to Kishorekumar R's interactive 3D portfolio. Click or press Enter on the doors to enter.</p>
                )}
